{
  "id": "f0f7fd5c-c567-434b-b4d6-526cb6814f05",
  "name": "src.main.resources.SimpleMicroserviceProcess-taskform.frm",
  "model": {
    "processName": "SimpleMicroserviceProcess",
    "processId": "src.main.resources.SimpleMicroserviceProcess",
    "properties": [
      {
        "name": "firstname",
        "typeInfo": {
            ...
            "layoutComponents": [
              {
                ...
                "properties": {
                  ...
                  "form_id": "f0f7fd5c-c567-434b-b4d6-526cb6814f05"
                }
              }
            ]
          }
            ...
            "layoutComponents": [
              {
                "dragTypeName": "org.kie.workbench.common.forms.editor.client.editor.rendering.EditorFieldLayoutComponent",
                "properties": {
                  "field_id": "field_308408708381227E11",
                  "form_id": "f0f7fd5c-c567-434b-b4d6-526cb6814f05"
                }
              }
            ]
